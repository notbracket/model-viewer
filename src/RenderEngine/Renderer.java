...
public class Renderer 
{
	...
	public void render3D(Map<TexturedModel, List<Object>> entities) {
		
		for(TexturedModel model:entities.keySet()) {
			prepareTexturedModel(model);
			List<Object> batch = entities.get(model);
	...
	public void render2D(Map<TexturedModel, List<Object>> entities2D) {}
	...
	private void prepareInstance(Object object) {
		...
		Matrix4f transformationMatrix = Maths.createTransformationMatrix(object.getPosition(), object.getRx(), object.getRy(), object.getRz(), object.getScale());
		shader.loadTransformationMatrix(transformationMatrix);
		
	}
	
	
//	public void render(Object entity, StaticShader shader)
//	{
